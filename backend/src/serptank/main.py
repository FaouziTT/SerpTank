...
from serptank.modules.compliance import router as compliance_router
...
def _include_routers(app: FastAPI) -> None:
    ...
    app.include_router(compliance_router.public_router, prefix=API_PREFIX)
    app.include_router(compliance_router.account_router, prefix=API_PREFIX)
